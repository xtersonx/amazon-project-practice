...
describe('test suite: renderOrderSummary', ()=>{
  ...
  it('displays the cart', ()=>{
    ...
    expect(document.querySelector(`.js-quantity-label-${productId1}`).innerHTML).toEqual('1');
    expect(document.querySelector(`.js-quantity-label-${productId2}`).innerHTML).toEqual('2');
  ...
  it('updating the delivery option',()=>{
    ...
    expect(document.querySelector('.js-payment-summary-shippingprice').innerHTML).toEqual("$14.98");
